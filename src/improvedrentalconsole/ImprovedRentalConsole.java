 ...
 * @author Predator
 */
public class ImprovedRentalConsole extends Others {
    ...
    public static void main(String[] args) {
        ...
        if(jenisMember == "Silver") {
            ...
            System.out.println("| Jumlah Cashback              | : Rp. " + gm.getCashback());
            ...
            System.out.println("| Jumlah Cashback              | : Rp. " + pm.getCashback());
